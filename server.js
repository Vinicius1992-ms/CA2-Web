...
router.post('/items_submit', function(req, res) {
    itemCtrl.createItem(req,res);
...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('./views/CCTcafe.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('./views/CCTcafe.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('views/CCTcafe.xml', function(err, result) {
      if (err) throw (err);
      ...
      jsToXmlFile('views/CCTcafe.xml', result, function(err) {
